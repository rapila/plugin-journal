...
class Journal extends BaseJournal {
	...
	public function getJournalPage() {
		return PageQuery::create()->filterByPageType('journal')->joinPageProperty()->useQuery('PageProperty')->filterByName('blog_journal_id')->filterByValue($this->getId())->endUse()->findOne();
	}
