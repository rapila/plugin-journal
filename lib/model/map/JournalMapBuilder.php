...
/**
 * This class adds structure of 'journals' table to 'mini_cms' DatabaseMap object.
 *
 *
 *
 ...
 * @package    model.map
 */
class JournalMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'model.map.JournalMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('journals');
		$tMap->setPhpName('Journal');
