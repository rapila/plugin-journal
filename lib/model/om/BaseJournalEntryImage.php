  ...
  const PEER = 'JournalEntryImagePeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = JournalEntryImagePeer::NUM_COLUMNS - JournalEntryImagePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getDocument(PropelPDO $con = null)
	{
		if ($this->aDocument === null && ($this->document_id !== null)) {
			$this->aDocument = DocumentQuery::create()->findPk($this->document_id);
