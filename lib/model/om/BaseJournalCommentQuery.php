...
abstract class BaseJournalCommentQuery extends ModelCriteria
{
     ...
     *
     * @return   JournalComment|JournalComment[]|mixed the result, formatted by the current formatter
     */
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            JournalCommentPeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|JournalComment[]|mixed the list of results, formatted by the current formatter
     */
