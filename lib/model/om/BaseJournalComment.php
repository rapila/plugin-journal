...
/**
 * Base class that represents a row from the 'journal_comments' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseJournalComment extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'JournalCommentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        JournalCommentPeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = JournalCommentPeer::ID;
        }
    ...
    public function setUsername($v)
    {
        ...
        if ($this->user !== $v) {
            $this->user = $v;
            $this->modifiedColumns[] = JournalCommentPeer::USER;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = JournalCommentPeer::EMAIL;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = JournalCommentPeer::TEXT;
        }
    ...
    public function setJournalEntryId($v)
    {
        ...
        if ($this->journal_entry_id !== $v) {
            ...
            $this->modifiedColumns[] = JournalCommentPeer::JOURNAL_ENTRY_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JournalCommentPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JournalCommentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = JournalCommentPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = JournalCommentPeer::UPDATED_BY;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JournalCommentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(JournalCommentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if (!$this->isColumnModified(JournalCommentPeer::CREATED_BY)) {
                        $this->setCreatedBy(Session::getSession()->getUser()->getId());
                    }
                    if (!$this->isColumnModified(JournalCommentPeer::UPDATED_BY)) {
                ...
                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(JournalCommentPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                JournalCommentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JournalCommentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(JournalCommentPeer::USER)) {
            $modifiedColumns[':p' . $index++]  = '`USER`';
        }
        if ($this->isColumnModified(JournalCommentPeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`EMAIL`';
        }
        if ($this->isColumnModified(JournalCommentPeer::TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`TEXT`';
        }
        if ($this->isColumnModified(JournalCommentPeer::JOURNAL_ENTRY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`JOURNAL_ENTRY_ID`';
        }
        if ($this->isColumnModified(JournalCommentPeer::IS_PUBLISHED)) {
            $modifiedColumns[':p' . $index++]  = '`IS_PUBLISHED`';
        }
        if ($this->isColumnModified(JournalCommentPeer::ACTIVATION_HASH)) {
            $modifiedColumns[':p' . $index++]  = '`ACTIVATION_HASH`';
        }
        if ($this->isColumnModified(JournalCommentPeer::CREATED_AT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `journal_comments` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`ACTIVATION_HASH`':
                        $stmt->bindValue($identifier, $this->activation_hash, PDO::PARAM_STR);
                        break;
                    case '`CREATED_AT`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JournalCommentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JournalCommentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JournalComment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JournalComment'][$this->getPrimaryKey()] = true;
        $keys = JournalCommentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JournalCommentPeer::ID)) $criteria->add(JournalCommentPeer::ID, $this->id);
        if ($this->isColumnModified(JournalCommentPeer::USER)) $criteria->add(JournalCommentPeer::USER, $this->user);
        ...
        if ($this->isColumnModified(JournalCommentPeer::UPDATED_BY)) $criteria->add(JournalCommentPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(JournalCommentPeer::DATABASE_NAME);
        $criteria->add(JournalCommentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of JournalComment (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JournalComment Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JournalCommentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JournalCommentPeer();
        }
    ...
    public function getJournalEntry(PropelPDO $con = null)
    {
        if ($this->aJournalEntry === null && ($this->journal_entry_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aJournalEntry->addJournalComments($this);
             */
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addJournalCommentRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addJournalCommentsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addJournalCommentRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addJournalCommentsRelatedByUpdatedBy($this);
             */
        }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && JournalCommentPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(JournalCommentPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleJournalCommentOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }
