  ...
  const PEER = 'JournalEntryPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 9; // 9 = JournalEntryPeer::NUM_COLUMNS - JournalEntryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getJournal(PropelPDO $con = null)
	{
		if ($this->aJournal === null && ($this->journal_id !== null)) {
			$this->aJournal = JournalQuery::create()->findPk($this->journal_id);
	 ...
	 * @return     void
	 */
	public function initJournalComments()
	{
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collJournalComments) {
				foreach ((array) $this->collJournalComments as $o) {
