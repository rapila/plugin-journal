...
abstract class BaseJournal extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = JournalPeer::NUM_HYDRATE_COLUMNS.
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->journalEntrysScheduledForDeletion !== null) {
				if (!$this->journalEntrysScheduledForDeletion->isEmpty()) {
					JournalEntryQuery::create()
						->filterByPrimaryKeys($this->journalEntrysScheduledForDeletion->getPrimaryKeys(false))
						->delete($con);
	 ...
	 * @return     PropelCollection|array JournalEntry[] List of JournalEntry objects
	 * @throws     PropelException
	 */
	public function getJournalEntrys($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collJournalEntrys || null !== $criteria) {
