...
/**
 * Base class that represents a row from the 'journals' table.
 *
 *
 *
...
abstract class BaseJournal extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the use_captcha field.
     * Note: this column has a database default value of: true
     * @var        boolean
     */
    ...
    /**
     * @var        PropelObjectCollection|JournalEntry[] Collection to store aggregation of JournalEntry objects.
     */
    protected $collJournalEntrys;
    protected $collJournalEntrysPartial;
     ...
     */
    protected $journalEntrysScheduledForDeletion = null;
    ...
    /**
     * Get the [notify_comments] column value.
     *
     * @return boolean
     */
    public function getNotifyComments()
    {
    ...
    /**
     * Get the [use_captcha] column value.
     *
     * @return boolean
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = JournalPeer::NAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = JournalPeer::DESCRIPTION;
        }
    ...
    public function setEnableComments($v)
    {
        ...
        if ($this->enable_comments !== $v) {
            ...
            $this->modifiedColumns[] = JournalPeer::ENABLE_COMMENTS;
        }
    ...
    /**
     * Sets the value of the [notify_comments] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return Journal The current object (for fluent API support)
     */
    public function setNotifyComments($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
                $v = in_array(strtolower($v), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        ...
        if ($this->notify_comments !== $v) {
            $this->notify_comments = $v;
            $this->modifiedColumns[] = JournalPeer::NOTIFY_COMMENTS;
        }
    ...
    /**
     * Sets the value of the [use_captcha] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return Journal The current object (for fluent API support)
     */
    public function setUseCaptcha($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
                $v = in_array(strtolower($v), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        ...
        if ($this->use_captcha !== $v) {
            $this->use_captcha = $v;
            $this->modifiedColumns[] = JournalPeer::USE_CAPTCHA;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JournalPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JournalPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = JournalPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = JournalPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->enable_comments = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            $this->notify_comments = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
            $this->use_captcha = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
            ...
            return $startcol + 10; // 10 = JournalPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JournalQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // extended_timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(JournalPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(JournalPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->journalEntrysScheduledForDeletion !== null) {
                if (!$this->journalEntrysScheduledForDeletion->isEmpty()) {
                    foreach ($this->journalEntrysScheduledForDeletion as $journalEntry) {
                        // need to save related object because we set the relation to null
                        $journalEntry->save($con);
                    }
                    $this->journalEntrysScheduledForDeletion = null;
                }
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `journals` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Journal'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Journal'][$this->getPrimaryKey()] = true;
        $keys = JournalPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getDescription(),
            $keys[3] => $this->getEnableComments(),
            $keys[4] => $this->getNotifyComments(),
            $keys[5] => $this->getUseCaptcha(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collJournalEntrys) {
                $result['JournalEntrys'] = $this->collJournalEntrys->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setEnableComments($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setNotifyComments($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setUseCaptcha($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JournalPeer::NAME)) $criteria->add(JournalPeer::NAME, $this->name);
        if ($this->isColumnModified(JournalPeer::DESCRIPTION)) $criteria->add(JournalPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(JournalPeer::ENABLE_COMMENTS)) $criteria->add(JournalPeer::ENABLE_COMMENTS, $this->enable_comments);
        if ($this->isColumnModified(JournalPeer::NOTIFY_COMMENTS)) $criteria->add(JournalPeer::NOTIFY_COMMENTS, $this->notify_comments);
        if ($this->isColumnModified(JournalPeer::USE_CAPTCHA)) $criteria->add(JournalPeer::USE_CAPTCHA, $this->use_captcha);
        if ($this->isColumnModified(JournalPeer::CREATED_AT)) $criteria->add(JournalPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(JournalPeer::UPDATED_AT)) $criteria->add(JournalPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(JournalPeer::CREATED_BY)) $criteria->add(JournalPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(JournalPeer::UPDATED_BY)) $criteria->add(JournalPeer::UPDATED_BY, $this->updated_by);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNotifyComments($this->getNotifyComments());
        $copyObj->setUseCaptcha($this->getUseCaptcha());
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addJournalRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUserRelatedByCreatedBy->addJournalsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addJournalRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addJournalsRelatedByUpdatedBy($this);
             */
        }
    ...
    {
        if ('JournalEntry' == $relationName) {
            $this->initJournalEntrys();
        }
    }

    /**
     * Clears out the collJournalEntrys collection
     *
    ...
    public function clearJournalEntrys()
    {
        ...
        $this->collJournalEntrysPartial = null;

        return $this;
    }

    /**
     * reset is the collJournalEntrys collection loaded partially
     *
     * @return void
     */
    public function resetPartialJournalEntrys($v = true)
    {
        $this->collJournalEntrysPartial = $v;
    }

    /**
     * Initializes the collJournalEntrys collection.
     *
     ...
     * @return void
     */
    public function initJournalEntrys($overrideExisting = true)
    {
        if (null !== $this->collJournalEntrys && !$overrideExisting) {
            return;
        }
        $this->collJournalEntrys = new PropelObjectCollection();
        $this->collJournalEntrys->setModel('JournalEntry');
    }
     ...
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|JournalEntry[] List of JournalEntry objects
     * @throws PropelException
     */
    public function getJournalEntrys($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collJournalEntrysPartial && !$this->isNew();
        if (null === $this->collJournalEntrys || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collJournalEntrys) {
                // return empty collection
                $this->initJournalEntrys();
            } else {
                $collJournalEntrys = JournalEntryQuery::create(null, $criteria)
                    ->filterByJournal($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collJournalEntrysPartial && count($collJournalEntrys)) {
                      $this->initJournalEntrys(false);

                      foreach ($collJournalEntrys as $obj) {
                        if (false == $this->collJournalEntrys->contains($obj)) {
                          $this->collJournalEntrys->append($obj);
                        }
                      }

                      $this->collJournalEntrysPartial = true;
                    }

                    $collJournalEntrys->getInternalIterator()->rewind();

                    return $collJournalEntrys;
                }

                if ($partial && $this->collJournalEntrys) {
                    foreach ($this->collJournalEntrys as $obj) {
                        if ($obj->isNew()) {
                            $collJournalEntrys[] = $obj;
                        }
                    }
                }

                $this->collJournalEntrys = $collJournalEntrys;
                $this->collJournalEntrysPartial = false;
            }
        }
    ...
    /**
     * Sets a collection of JournalEntry objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $journalEntrys A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Journal The current object (for fluent API support)
     */
    public function setJournalEntrys(PropelCollection $journalEntrys, PropelPDO $con = null)
    {
        $journalEntrysToDelete = $this->getJournalEntrys(new Criteria(), $con)->diff($journalEntrys);


        $this->journalEntrysScheduledForDeletion = $journalEntrysToDelete;

        foreach ($journalEntrysToDelete as $journalEntryRemoved) {
            $journalEntryRemoved->setJournal(null);
        }
        ...
        $this->collJournalEntrys = $journalEntrys;
        $this->collJournalEntrysPartial = false;
    ...
    public function countJournalEntrys(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collJournalEntrys || null !== $criteria || $partial) {
            ...
            if ($partial && !$criteria) {
                return count($this->getJournalEntrys());
            }
            $query = JournalEntryQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collJournalEntrys);
    }
    ...
    public function addJournalEntry(JournalEntry $l)
    {
        ...
        if (!in_array($l, $this->collJournalEntrys->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddJournalEntry($l);

            if ($this->journalEntrysScheduledForDeletion and $this->journalEntrysScheduledForDeletion->contains($l)) {
                $this->journalEntrysScheduledForDeletion->remove($this->journalEntrysScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param	JournalEntry $journalEntry The journalEntry object to remove.
     * @return Journal The current object (for fluent API support)
     */
    public function removeJournalEntry($journalEntry)
    {
        if ($this->getJournalEntrys()->contains($journalEntry)) {
            $this->collJournalEntrys->remove($this->collJournalEntrys->search($journalEntry));
            if (null === $this->journalEntrysScheduledForDeletion) {
                $this->journalEntrysScheduledForDeletion = clone $this->collJournalEntrys;
                $this->journalEntrysScheduledForDeletion->clear();
            }
            $this->journalEntrysScheduledForDeletion[]= $journalEntry;
     ...
     * been saved, it will retrieve related JournalEntrys from storage.
     *
     ...
     * @return PropelObjectCollection|JournalEntry[] List of JournalEntry objects
     */
    public function getJournalEntrysJoinUserRelatedByCreatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = JournalEntryQuery::create(null, $criteria);
        $query->joinWith('UserRelatedByCreatedBy', $join_behavior);

        return $this->getJournalEntrys($query, $con);
    }
     ...
     * @return PropelObjectCollection|JournalEntry[] List of JournalEntry objects
     */
    public function getJournalEntrysJoinUserRelatedByUpdatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = JournalEntryQuery::create(null, $criteria);
    ...
    public function clear()
    {
        ...
        $this->notify_comments = null;
        $this->use_captcha = null;
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collJournalEntrys) {
                foreach ($this->collJournalEntrys as $o) {
        ...
        if ($this->collJournalEntrys instanceof PropelCollection) {
            $this->collJournalEntrys->clearIterator();
        }
        $this->collJournalEntrys = null;
        $this->aUserRelatedByCreatedBy = null;
        $this->aUserRelatedByUpdatedBy = null;
    ...
    {
        return (string) $this->exportTo(JournalPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && JournalPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(JournalPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleJournalOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }
