 ...
 *
 * @method     JournalEntryQuery leftJoinJournal($relationAlias = '') Adds a LEFT JOIN clause to the query using the Journal relation
 * @method     JournalEntryQuery rightJoinJournal($relationAlias = '') Adds a RIGHT JOIN clause to the query using the Journal relation
 * @method     JournalEntryQuery innerJoinJournal($relationAlias = '') Adds a INNER JOIN clause to the query using the Journal relation
 *
 * @method     JournalEntryQuery leftJoinUserRelatedByCreatedBy($relationAlias = '') Adds a LEFT JOIN clause to the query using the UserRelatedByCreatedBy relation
 * @method     JournalEntryQuery rightJoinUserRelatedByCreatedBy($relationAlias = '') Adds a RIGHT JOIN clause to the query using the UserRelatedByCreatedBy relation
 * @method     JournalEntryQuery innerJoinUserRelatedByCreatedBy($relationAlias = '') Adds a INNER JOIN clause to the query using the UserRelatedByCreatedBy relation
 *
 * @method     JournalEntryQuery leftJoinUserRelatedByUpdatedBy($relationAlias = '') Adds a LEFT JOIN clause to the query using the UserRelatedByUpdatedBy relation
 * @method     JournalEntryQuery rightJoinUserRelatedByUpdatedBy($relationAlias = '') Adds a RIGHT JOIN clause to the query using the UserRelatedByUpdatedBy relation
 * @method     JournalEntryQuery innerJoinUserRelatedByUpdatedBy($relationAlias = '') Adds a INNER JOIN clause to the query using the UserRelatedByUpdatedBy relation
 *
 * @method     JournalEntryQuery leftJoinJournalComment($relationAlias = '') Adds a LEFT JOIN clause to the query using the JournalComment relation
 * @method     JournalEntryQuery rightJoinJournalComment($relationAlias = '') Adds a RIGHT JOIN clause to the query using the JournalComment relation
 * @method     JournalEntryQuery innerJoinJournalComment($relationAlias = '') Adds a INNER JOIN clause to the query using the JournalComment relation
 *
 * @method     JournalEntryQuery leftJoinJournalEntryImage($relationAlias = '') Adds a LEFT JOIN clause to the query using the JournalEntryImage relation
 * @method     JournalEntryQuery rightJoinJournalEntryImage($relationAlias = '') Adds a RIGHT JOIN clause to the query using the JournalEntryImage relation
 * @method     JournalEntryQuery innerJoinJournalEntryImage($relationAlias = '') Adds a INNER JOIN clause to the query using the JournalEntryImage relation
 *
...
abstract class BaseJournalEntryQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'mini_cms', $modelName = 'JournalEntry', $modelAlias = null)
	{
	 ...
	 *
	 * @return    JournalEntry|array|mixed the result, formatted by the current formatter
	 */
	public function findPk($key, $con = null)
	{
		if ((null !== ($obj = JournalEntryPeer::getInstanceFromPool((string) $key))) && $this->getFormatter()->isObjectFormatter()) {
	 ...
	 * @return    JournalEntryQuery The current query, for fluid interface
	 */
	public function joinJournal($relationAlias = '', $joinType = Criteria::LEFT_JOIN)
	{
	 ...
	 */
	public function useJournalQuery($relationAlias = '', $joinType = Criteria::LEFT_JOIN)
	{
		return $this
	 ...
	 *
	 * @param     JournalComment $journalComment  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    JournalEntryQuery The current query, for fluid interface
	 */
	 ...
	 * @return    JournalEntryQuery The current query, for fluid interface
	 */
	public function joinJournalComment($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		$tableMap = $this->getTableMap();
	 ...
	 */
	public function useJournalCommentQuery($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		return $this
	 ...
	 *
	 * @param     JournalEntryImage $journalEntryImage  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    JournalEntryQuery The current query, for fluid interface
	 */
	 ...
	 * @return    JournalEntryQuery The current query, for fluid interface
	 */
	public function joinJournalEntryImage($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		$tableMap = $this->getTableMap();
	 ...
	 */
	public function useJournalEntryImageQuery($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		return $this
	 ...
	 *
	 * @return     JournalEntryQuery The current query, for fuid interface
	 */
